...
| 插件 | 路径 | 状态 | 说明 |
| --- | --- | --- | --- |
| Layer Locator / 图层快速定位 | `plugins/layer-quick-jump/` | `0.1.0 beta` | 保存常用图层或图层组位置，并从当前文档中快速跳回。尚未经过完整实际项目跑测。 |
...
| --- | --- | --- | --- |
| Layer Locator | `plugins/layer-quick-jump/` | `0.1.0 beta` | Saves frequently used layer or group positions and jumps back to them in the active document. Not yet fully tested in real production files. |
